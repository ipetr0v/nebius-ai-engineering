...
> Sourse: https://taskchecker.academy.nebius.com/tasks/ai-performance-engineering-2026
...
```json
{
  ...
  "structure": "The project follows a standard Python package layout with the main source code in `src/`..."
}
```
